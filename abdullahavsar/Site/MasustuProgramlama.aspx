<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.master" AutoEventWireup="true" CodeFile="MasustuProgramlama.aspx.cs" Inherits="Site_MasustuProgramlama" %>
              ...
              <ItemTemplate>  
                  ...
                  <tr>
                    <td colspan="3" align="left">
                      <a href='<%#String.Format("makaleler/{0}_{1}",ToUrl.UrlDonustur(Eval("MAKALEBASLIK").ToString()),Eval("MAKALEID").ToString())%>'><asp:Label ID="lblMakaleBaslik" runat="server" Text=<%#Eval("MAKALEBASLIK")%>  Font-Bold="true" Font-Names="Verdana"  BorderStyle="None" ForeColor="Black" Font-Underline="false" Font-Size="Smaller"> </asp:Label></a> 
                    </td>
                  </tr>
                            <tr>

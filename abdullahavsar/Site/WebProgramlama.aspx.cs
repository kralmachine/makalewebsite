...
public partial class WebProgramlama : System.Web.UI.Page
{
    ...
    private void rpWebProKAtegori()
    {
        DataTable getTableMasaustuList = DB.getTable("SELECT * FROM KATEGORILER WHERE KATEGORIID=2");

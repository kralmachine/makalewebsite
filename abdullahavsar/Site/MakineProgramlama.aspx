<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.master" AutoEventWireup="true" CodeFile="MakineProgramlama.aspx.cs" Inherits="Site_MakineProgramlama" %>
              ...
              <ItemTemplate>  
                  ...
                  <tr>
                    <td colspan="3" align="left">
                       <a href='<%#String.Format("makaleler/{0}_{1}",ToUrl.UrlDonustur(Eval("MAKALEBASLIK").ToString()),Eval("MAKALEID").ToString())%>'><asp:Label ID="lblMakaleBaslik" runat="server" Text=<%#Eval("MAKALEBASLIK")%>  Font-Bold="true" Font-Names="Verdana" ForeColor="Black" Font-Underline="false"  BorderStyle="None"  Font-Size="Smaller"> </asp:Label></a>
                    </td>
                  </tr>
                            <tr>
